...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here we change the footer content of your admin panel.
    |
    */
    'copyright_end_year' => date('Y', strtotime('+1 year')),
    'author' => 'KiXcellent.Tech',
    'author_url' => 'http://kixcellent.tech',
    'app_version' => '3.2.0',
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'active' => ['permissions*', 'regex:@^permissions/[0-9]+$@'],
        ],
        [
            'text'    => 'multilevel',
